...
export class QobuzToolsDefinition {
  ...
  public static readonly searchArtistCommand: ToolDeclaration = {
    ...
    description:
      ...
      'If the search returns no artist, the Qobuz catalog does not carry them. Do not call this tool again with another spelling. The one tool that may be tried after that is youtube_search_music, and only after this has come back empty.',
    parameters: {
      type: Type.OBJECT,
      properties: {
        artist_name: {
  ...
  public static readonly findArtistTrackCommand: ToolDeclaration = {
    ...
    description:
      ...
      'An empty answer means that artist has no such release on Qobuz. Do not retry it through qobuz_search_artist hoping for a longer list: that list would be other people. The only step left is youtube_search_music, once.',
    parameters: {
      type: Type.OBJECT,
      properties: {
        artist_name: {
