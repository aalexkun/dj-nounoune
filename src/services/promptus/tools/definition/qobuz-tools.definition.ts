...
export class QobuzToolsDefinition {
  ...
  public static readonly findArtistTrackCommand: ToolDeclaration = {
    ...
    description:
      ...
      'An empty answer is final and means that artist has no such release — say so. Do not retry it through qobuz_search_artist hoping for a longer list: that list would be other people.',
    parameters: {
      type: Type.OBJECT,
      properties: {
        artist_name: {
